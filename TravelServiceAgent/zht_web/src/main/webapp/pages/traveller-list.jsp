								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/pages/traveller-add.jsp'">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc sorting_desc_disabled">手机号码</th>
										<th class="sorting">证件类型</th>
										<th class="text-center sorting">证件号码</th>
								...
								<tbody>
									...
									<c:forEach items="${travellerList}" var="traveller">
										...
										<tr>
											...
											<td class="text-center">${traveller.credentialsTypeStr }</td>
											<td>${traveller.credentialsNum}</td>
											<td class="text-center">${traveller.travellerTypeStr}</td>
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs">编辑</button>
												<a href="${pageContext.request.contextPath}/traveller/deleteTraveller.do?id=${traveller.id}" class="btn bg-olive btn-xs" onclick='confirm("你确认要删除吗？")'>删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
